...
|--------|-------------|-----------|-------------|
| -i | --inclusion | FASTA | A list of inclusion targets in FASTA format. You may list multiple file or directory locations following the parameter. Neptune will automatically include all root-level files within directories. |
| -e | --exclusion | FASTA | A list of exclusion targets in FASTA format. You may list multiple file or directory locations following the parameter. Neptune will automatically include all root-level files within directories. |
